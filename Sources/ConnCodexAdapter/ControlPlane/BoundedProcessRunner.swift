...
private final class ProcessExecution: @unchecked Sendable {
    ...
    private func finish(terminationStatus: Int32) {
        ...
        // Do not synchronously drain to EOF here. A grandchild may inherit a
        // write descriptor after the direct child exits, which would make
        // readDataToEndOfFile defeat this runner's timeout. Readability
        // handlers have already captured bounded data delivered before exit.
